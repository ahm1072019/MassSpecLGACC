...
tiff(file="2023_5_8_LGACC_mass_spec_heatmap.tiff", width = 10, height = 20, units = "in", res = 800)
...
tiff(file="2022_7_29_LGACC_mass_spec_PCA.tiff", width = 10, height = 20, units = "in", res = 800)
...
write.csv(table, "2022_1_11_MassSpec_Limma_toptable.csv")

t <- read.csv("2022_1_11_MassSpec_Limma_toptable.csv")
